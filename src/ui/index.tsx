...
const InlineCode: React.SFC<StringChildren> = (props) => (
  <code className={styles.inlineCode} {...props} />
);

const Blockquote: React.SFC<QuoteProps> = (props) => {
  const type = props.children[1].props.children;
  return <blockquote className={styles.tips} data-type={type} {...props} />;
};
...
const A: React.SFC<AProps> = (props) => (
  <a href={props.href} style={{ fontSize: 16 }}>
    {props.children}
    <Icon type="export" />
  </a>
);
...
export { H3, InlineCode, Blockquote, Em, Img, A };
